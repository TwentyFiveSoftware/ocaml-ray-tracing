...
let camera = Camera.new_camera {Vec3.x = 12.0; y = 2.0; z = -3.0} Vec3.zero 25.0 width height
let scene = Scene.generate_scene ()

let renderer = {Renderer.width = width; height; samples_per_pixel; max_ray_recursive_depth; camera; scene}
